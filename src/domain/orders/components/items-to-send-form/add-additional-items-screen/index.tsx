...
import useAddAdditionalItemsColumns from "./add-additional-items-columns"
...
const AddAdditionalItemsScreen = ({
  ...
  const numPages = useMemo(() => (count ? Math.ceil(count / PAGE_SIZE) : 0), [
    count,
  ])
