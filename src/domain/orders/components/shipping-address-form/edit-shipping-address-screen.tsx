...
const EditShippingAddressScreen = ({ form, order }: Props) => {
  const {
    resetField,
    path,
    formState: { errors },
...
const useEditShippingAddressScreen = () => {
  ...
  const pushScreen = (props: Props) => {
    push({
      ...
      onBack: () => pop(),
      view: <EditShippingAddressScreen {...props} />,
    })
  }
...
export default useEditShippingAddressScreen
