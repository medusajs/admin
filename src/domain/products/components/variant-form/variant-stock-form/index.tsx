        ...
        <FeatureToggle featureFlag="inventoryService">
          ...
          >
            <div className="flex flex-col">
              <div className="mb-4 flex flex-col gap-y-2xsmall">
              ...
              <div className="flex flex-col gap-y-base pb-6">
              ...
              {!!selectedLocations.length && (
                <div className="mb-6 flex items-center justify-between border-t border-dashed pt-6 text-grey-50">
