...
const ThumbnailModal = ({ product_type, open, onClose }: Props) => {
...
const getDefaultValues = (product_type: ProductType): ThumbnailFormWrapper => {
  return {
    thumbnail: {
      images: product_type.thumbnail
        ? [
            {
              url: product_type.thumbnail,
            },
          ]
        : [],
    },
