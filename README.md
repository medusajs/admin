## Important update
This repository is currently in maintainance mode, so we are only fixing bugs. We moved Medusa Admin to our core repository to centralise our projects and ship it as a plugin through `npm` - similar to all other packages. You'll find the admin in package [`admin-ui`](https://github.com/medusajs/medusa/tree/master/packages/admin-ui). If you continue using this project and you find bugs, we'd appreciate, if you could file them in both repositories.
